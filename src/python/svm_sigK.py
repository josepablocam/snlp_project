...
#### MaxEnt experiments #######
def experiment_svm_sigK(train, test, featurizer):
    return experiment(Models.report_SVM_sigK, train, test, featurizer)
...
experiment1_b = experiment_svm_sigK(blog_80, blog_20, feat1)
print "=>Experiment 1: valence twitter+wiki -> blog"
experiment1_twb = experiment_svm_sigK(tw, blog, feat1)
print "=>Experiment 1: valence twitter+wiki -> twitter(test)"
experiment1_tw = experiment_svm_sigK(tw, twitter_test, feat1)
...
experiment2_b = experiment_svm_sigK(blog_80, blog_20, feat2)
print "=>Experiment 2: tf-idf twitter+wiki -> blog"
experiment2_twb = experiment_svm_sigK(tw, blog, feat2)
print "=>Experiment 2: tf-idf twitter+wiki -> twitter(test)"
experiment2_tw = experiment_svm_sigK(tw, twitter_test, feat2)
...
experiment3_b = experiment_svm_sigK(blog_80, blog_20, feat3)
print "=>Experiment 3: valence + tf-idf twitter+wiki -> blog"
experiment3_twb = experiment_svm_sigK(tw, blog, feat3)
print "=>Experiment 3: valence + tf-idf twitter+wiki -> twitter(test)"
experiment3_tw = experiment_svm_sigK(tw, twitter_test, feat3)
...
experiment4_b = experiment_svm_sigK(blog_80, blog_20, feat4)
print "=>Experiment 4: valence + tf-idf + punctuation twitter+wiki -> blog"
experiment4_twb = experiment_svm_sigK(tw, blog, feat4)
print "=>Experiment 4: valence + tf-idf + punctuation twitter+wiki -> twitter(test)"
experiment4_tw = experiment_svm_sigK(tw, twitter_test, feat4)
...
experiment5_b = experiment_svm_sigK(blog_80, blog_20, feat5)
print "=>Experiment 5: valence + punctuation twitter+wiki -> blog"
experiment5_twb = experiment_svm_sigK(tw, blog, feat5)
print "=>Experiment 5: valence + punctuation twitter+wiki -> twitter(test)"
experiment5_tw = experiment_svm_sigK(tw, twitter_test, feat5)
