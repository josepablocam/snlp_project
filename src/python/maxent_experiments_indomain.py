...
# experiment7_tmh = experiment_maxent(twitter_PN, t_test, feat5)
# # Training on 80% blog, testing on 20% blog
# print "T(80) -> T(20)"
# experiment7_t = experiment_maxent(t_80, t_20, feat5)
# print "B(80) -> B(20)"
# experiment7_b = experiment_maxent(blog_80, blog_20, feat5)
# print "B_emotion(80) -> B_emotion(20)"
# experiment7_be = experiment_maxent(blog_80_emotion, blog_20_emotion, feat5)
...
# # Testing on 20% tw
# # print "TW(80) -> TW(20)"
# # experiment1_tw = experiment_maxent(tw_80, tw_20, feat1)
# # Training on 80% tw
# # Testing on 20% tw
# # train on twitter machine, test on twitter human
#
#
# print "T(machine) -> T(human)"
# experiment1_tmh = experiment_maxent(twitter_PN, t_test, feat1)
# print "T(80) -> T(20)"
# experiment1_t = experiment_maxent(t_80, t_20, feat1)
#
...
# print "B_emotion(80) -> B_emotion(20)"
# experiment1_be = experiment_maxent(blog_80_emotion, blog_20_emotion, feat1)
#
#
...
# # train on twitter machine, test on twitter human
# print "T(machine) -> T(human)"
# experiment2_tmh = experiment_maxent(twitter_PN, t_test, feat2)
# print "T(80) -> T(20)"
# experiment2_t = experiment_maxent(t_80, t_20, feat2)
# # Training on 80% blog, testing on 20% blog
# print "B(80) -> B(20)"
# experiment2_b = experiment_maxent(blog_80, blog_20, feat2)
# print "B_emotion(80) -> B_emotion(20)"
# experiment2_be = experiment_maxent(blog_80_emotion, blog_20_emotion, feat2)
#
#
...
# # train on twitter machine, test on twitter human
# print "T(machine) -> T(human)"
# experiment3_tmh = experiment_maxent(twitter_PN, t_test, feat3)
# print "T(80) -> T(20)"
# experiment3_t = experiment_maxent(t_80, t_20, feat3)
# print "B(80) -> B(20)"
# experiment3_b = experiment_maxent(blog_80, blog_20, feat3)
# print "B_emotion(80) -> B_emotion(20)"
# experiment3_be = experiment_maxent(blog_80_emotion, blog_20_emotion, feat3)
#
#
# ##################### Linear SVM  + tf-idf ############################
...
# # train on twitter machine, test on twitter human
# print "T(machine) -> T(human)"
# experiment4_tmh = experiment_maxent(twitter_PN, t_test, feat4)
# # Training on 80% blog, testing on 20% blog
# print "T(80) -> T(20)"
# experiment4_t = experiment_maxent(t_80, t_20, feat4)
# print "B(80) -> B(20)"
# experiment4_b = experiment_maxent(blog_80, blog_20, feat4)
# print "B_emotion(80) -> B_emotion(20)"
# experiment4_be = experiment_maxent(blog_80_emotion, blog_20_emotion, feat4)
#
#
...
# # train on twitter machine, test on twitter human
# print "T(machine) -> T(human)"
# experiment6_tmh = experiment_maxent(twitter_PN, t_test, feat6)
# # Training on 80% blog, testing on 20% blog
# print "T(80) -> T(20)"
# experiment6_t = experiment_maxent(t_80, t_20, feat6)
# print "B(80) -> B(20)"
# experiment6_b = experiment_maxent(blog_80, blog_20, feat6)
# print "B_emotion(80) -> B_emotion(20)"
# experiment6_be = experiment_maxent(blog_80_emotion, blog_20_emotion, feat6)
# # Training on 80% tw
# # Testing on 20% tw
# # print "TW(80) -> TW(20)"
# # experiment5_tw = experiment_maxent(tw_80, tw_20, feat5)
# # Training on 80% tw
# # Testing on 20% tw
...
# train on twitter machine, test on twitter human
print "T(machine) -> T(human)"
experiment5_tmh = experiment_maxent(twitter_PN, t_test, feat5)

exit()
# Training on 80% blog, testing on 20% blog
print "T(80) -> T(20)"
experiment5_t = experiment_maxent(t_80, t_20, feat5)
print "B(80) -> B(20)"
experiment5_b = experiment_maxent(blog_80, blog_20, feat5)
print "B_emotion(80) -> B_emotion(20)"
experiment5_be = experiment_maxent(blog_80_emotion, blog_20_emotion, feat5)
# Training on 80% tw
# Testing on 20% tw
# print "TW(80) -> TW(20)"
# experiment5_tw = experiment_maxent(tw_80, tw_20, feat5)
